...
const Result = ({ userInfo, setUserInfo }) => {
  return (
    <Root>
      ...
      <p>{userInfo.bio}</p>
      <a href={userInfo.html_url} rel="noreferrer" target="_blank">Visit Github</a>
      <Ul>
        <li><strong>Followers</strong>{userInfo.followers}</li>
        <li><strong>Following</strong>{userInfo.following}</li>
        <li><strong>Repos</strong>{userInfo.public_repos}</li>
      </Ul>
    </Root>
  );
};
